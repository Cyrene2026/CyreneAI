...
from cyrenebot.core.errors.base import StateError, UnsupportedError
from cyrenebot.core.provider.provider_protocol import ChatProviderProtocol
from cyrenebot.core.schema.base import CyreneBotSchema
from cyrenebot.core.schema.chat import ChatRequest, ChatResponse
from cyrenebot.core.schema.context import (
    ContextBudget,
    ContextBuildRequest,
    ContextBuildResult,
    ContextItem,
...
from cyrenebot.core.schema.message import ContentPart, ContentPartType, Message, MessageRole
from cyrenebot.core.schema.skill import (
    SkillInstructionBundle,
    SkillSelectionRequest,
)
from cyrenebot.core.schema.tool import ToolChoice, ToolDefinition, ToolResult


class ApplicationChatRequest(CyreneBotSchema):
    """
    应用聊天请求
    """
...
class ApplicationChatResult(CyreneBotSchema):
    """
    应用聊天结果
    """
...
class ChatOrchestrator:
    ...
    def __init__(self, runtime: CyreneBotRuntime) -> None:
