...
from cyrenebot.infra.adapters.providers.openai_responses.errors import raise_openai_error
from cyrenebot.infra.adapters.providers.openai_responses.mapper import (
